...
export default function EuresForhandsvisning({ setVisHovedinnhold, kategorier }) {
        ...
        <>
            ...
            <HStack className={`${styles.preview} ${styles.mt16} ${styles.wrapText}`}>
                <Box>
                    ...
                    {kategorier.includes(EuresKategoriEnum.PERSONALIA) && (
                        <>
                            ...
                            <dl aria-label="Personalia" className={styles.previewPersonalInfoWrapper}>
                                <div className={styles.previewPersonalInfo}>
                                    ...
                                    <dd className={styles.PersonalInfoValue}>
                                        <BodyLong size="small">
                                            {personalia
                                                ? formatterFullDatoMedFallback(personalia.foedselsdato, "")
                                                : ""}
                                        </BodyLong>
                                    </dd>
                                </div>
                    ...
                    {cv.utdanning && cv.utdanning.length !== 0 && kategorier.includes(EuresKategoriEnum.UTDANNING) && (
                    ...
                    {cv.arbeidserfaring &&
                        ...
                        kategorier.includes(EuresKategoriEnum.ARBEIDSFORHOLD) && (
                            <section aria-labelledby="heading-preview-arbeidsforhold" className={styles.previewSection}>
                                <Heading
                                    id="heading-preview-arbeidsforhold"
                                    level="2"
                                    size="xsmall"
                    ...
                    {cv.kompetanser &&
                        ...
                        kategorier.includes(EuresKategoriEnum.KOMPETANSER) && (
                            <section aria-labelledby="heading-preview-kompetanser" className={styles.mb6}>
                                <Heading
                                    id="heading-preview-kompetanser"
                                    level="2"
                                    size="xsmall"
                                    className={styles.mb3}
                                >
