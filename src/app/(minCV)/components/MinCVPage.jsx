                    ...
                    <VStack align="center">
                        <HStack align="start" gap="8">
                            ...
                            <VStack gap={{ xs: "4", md: "5" }}>
                                <HStack gap="8">
                                <Heading level="1" size="large">Din CV</Heading>
                                    <Tag size="small" variant="info-filled">Påbegynt</Tag>
                                </HStack>
                                <Hide below="md">
    ...
    return (
        <svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <g clipPath="url(#clip0_2035_24190)">
                <rect x="60.5" y="25.2085" width="37.3333" height="7" transform="rotate(-180 60.5 25.2085)"
                      fill="#EBFCFF" />
                <rect x="53.5" y="41.5415" width="37.3333" height="7" transform="rotate(-180 53.5 41.5415)"
                      fill="#EBFCFF" />
                <rect x="45.334" y="57.2915" width="37.3333" height="7" transform="rotate(-180 45.334 57.2915)"
                      fill="#EBFCFF" />
                <path d="M12.8758 14.7697L13.7326 16.0461L17.6075 13.3213" stroke="#23262A" strokeWidth="2"
                      strokeLinecap="round" strokeLinejoin="round" />
                <path d="M21.0438 26.2565L21.9006 27.5329L25.7754 24.8081" stroke="#23262A" strokeWidth="2"
                      strokeLinecap="round" strokeLinejoin="round" />
                ...
                <rect x="8" y="8" width="30.3333" height="24.5" rx="1.33333" stroke="#23262A" strokeWidth="4"
                ...
                <path
                    ...
                    stroke="#23262A" strokeWidth="2" />
                <path d="M36.459 48.8521L47.0276 53.9327L61.1191 48.8521" stroke="#23262A" strokeWidth="2"
