    ...
    return (
        <div>
            <Box background="surface-default" padding="10" style={{ width: "600px", marginBottom: "2rem" }}>
                ...
                <BodyLong spacing>
                    Du har muligheten til å registrere og ha din CV lagret på arbeidsplassen.no slik at du kan ta vare
                    på den, laste den ned og dele den, om du ønsker.
                </BodyLong>
                <HStack gap="4">
                ...
                <BodyLong spacing>
                    Den Europeiske Jobbmobilitetsportalen (EURES-Portalen) er et tilbud til deg som ønsker å finne en
                    jobb i EU/EØS-området og Sveits.
                </BodyLong>
                <BodyLong spacing>
                    Portalen gir deg muligheten til å gjøre CV-en din tilgjengelig for arbeidsgivere i EU/EØS og Sveits
                    ved å dele CV-en du har på arbeidsplassen.no.
                </BodyLong>
                <BodyLong spacing>
